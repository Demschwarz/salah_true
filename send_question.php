...
try {
    ...
    $mail->Subject = 'The customer wants to ask a question';
    $mail->Body    = "Имя пользователя: ${userName}, его телефон: ${userPhone}, его вопрос: ${userEmail}";
